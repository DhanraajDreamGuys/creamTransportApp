...
public class ViewEngineCodec extends AppCompatActivity {
    Toolbar mToolbar;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (mData != null) {
            ...
            if (mData.getType().equalsIgnoreCase("cummins")) {
                mCodeType.setText(getString(R.string.str_cummins));
            } else {
                mCodeType.setText(getString(R.string.str_catapillar));
            }
            ...
            if (mData.getStatus().equalsIgnoreCase("0")) {
                ...
                mStatus.setBackgroundDrawable(ContextCompat.getDrawable(ViewEngineCodec.this, R.drawable.button_background_green));
            } else {
                mStatus.setChecked(false);
                mStatus.setBackgroundDrawable(ContextCompat.getDrawable(ViewEngineCodec.this, R.drawable.button_background_red));
            }
        }
    ...
    private void intiWidgets() {
        ...
        mToolbar.setTitle(getString(R.string.tool_view_engine_codec_title));
