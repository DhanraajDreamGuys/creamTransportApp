 ...
 */
public class UserstatuslistAPI {
    private static UserstatuslistAPI ourInstance = new UserstatuslistAPI();

    public static UserstatuslistAPI getInstance() {
        return ourInstance;
    }

    private UserstatuslistAPI() {
    }
