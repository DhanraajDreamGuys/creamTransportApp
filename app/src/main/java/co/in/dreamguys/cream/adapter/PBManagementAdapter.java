...
import co.in.dreamguys.cream.PBManagement;
...
public class PBManagementAdapter extends BaseAdapter {
    Context mContext;
    List<PBManagementAPI.Datum> data;
    private List<PBManagementAPI.Datum> dataDupliate = new ArrayList<PBManagementAPI.Datum>();
    LayoutInflater mInflater;
    private boolean searchEnabled = false;
    private String searchTerm;

    public PBManagementAdapter(PBManagement mContext, List<PBManagementAPI.Datum> data) {
    ...
    @Override
    public PBManagementAPI.Datum getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final PBManagementAPI.Datum mData = searchEnabled ? dataDupliate.get(position) : data.get(position);
        ViewHolder mHolder;
        if (convertView == null) {
            mHolder = new ViewHolder();
            convertView = mInflater.inflate(R.layout.adapter_pb_management, null);
        ...
        mHolder.mIncharge.setText(mData.getPosition());
        ...
        mHolder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mCallView.putExtra(Constants.PB_MANAGEMENT_DATA, mData);
    ...
    private void filter() {
        ...
        if (searchTerm.length() == 0) {
            ...
            for (PBManagementAPI.Datum row : data) {
