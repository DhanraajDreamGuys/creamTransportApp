...
import co.in.dreamguys.cream.EditFridgeCodec;
import co.in.dreamguys.cream.FridgeCodec;
import co.in.dreamguys.cream.R;
import co.in.dreamguys.cream.ViewFridgeCodec;
 ...
 */
public class FridgeCodecAdapter extends BaseAdapter {
    Context mContext;
    ...
    public FridgeCodecAdapter(Context mContext, List<FridgeCodeAPI.Datum> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        mHolder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent mCallFridgeCodec = new Intent(mContext, ViewFridgeCodec.class);
                mCallFridgeCodec.putExtra(Constants.FRIDGE_CODE_DATA, mData);
                mContext.startActivity(mCallFridgeCodec);
                if (FridgeCodec.searchView != null)
                    FridgeCodec.searchView.onActionViewCollapsed();
            }
        });
        ...
        mHolder.mEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent mCallFridgeCodec = new Intent(mContext, EditFridgeCodec.class);
                mCallFridgeCodec.putExtra(Constants.FRIDGE_CODE_DATA, mData);
                mContext.startActivity(mCallFridgeCodec);
                if (FridgeCodec.searchView != null)
                    FridgeCodec.searchView.onActionViewCollapsed();
